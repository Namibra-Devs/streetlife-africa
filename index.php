...
<main>
  ...
  <section class="hero-section">
    <div class="hero-header">
      <div class="dark-bg">
        <div class="hero-banner" data-aos="fade-left" data-aos-delay="100">
          <h4 class="hero-title">
            <?php
      ...
      <div class="img-bg">
        <div class="hero-para" data-aos="fade-right">
          <p class="hero-text">
            <?php
    ...
    <div>
      ...
      <div class="flex">
        <div class="bg-primary-clr">
          <h4 class="text-2xl speciality-title">EVENT PRODUCTION</h4>
        ...
        <div class="bg-dark">
          <h4 class="text-2xl speciality-title">STORYTELLING</h4>
        ...
        <div class="bg-dark-800">
          <h4 class="text-2xl speciality-title">TALENT MANAGEMENT</h4>
  ...
  <section class="more__about">
    <div class="more__about__text" data-aos="fade-right" data-aos-delay="100">
    ...
    <div class="more__about__img-container" data-aos="fade-left" data-aos-delay="100">
  ...
  <section>
    <div class="performers">
      ...
      <!-- Profile cards -->
      <div class="perfomers-slider swiper" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="past-performer item">
                    ...
                    <div class="past-performer__profile-content">
                      ...
                      <div class="past-performer__slider-btns">
                        <button class="performer-button-next">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18"></path>
                          </svg>
                        </button>
                        <button class="performer-button-prev">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75">
                            </path>
                          </svg>
  ...
  <section>
    <div id="scroll-text__container" data-aos="fade-left" data-aos-delay="200">
  ...
  <section class="contact-section" data-aos="fade-up" data-aos-delay="100">
    <div class="contact-content">
      <div class="contact-text" data-aos="fade-right" data-aos-delay="200">
